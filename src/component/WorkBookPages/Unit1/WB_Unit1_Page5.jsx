...
import page_2 from "../../../assets/workpages/5.png"
    ...
    <div className="relative w-full h-full flex justify-center items-center">
      ...
      >
        ...
        >
         ...
         <div
        className="wb-unit1-p3-q2 hover:scale-110 transition"
        style={{ overflow: "visible" , position:"absolute",top:"24.0%",left:"61%"  }}
      >
        <svg
          width="22"
          height="22"
        ...
        >
          ...
          <div
        className="wb-unit1-p3-q2 hover:scale-110 transition"
        style={{ overflow: "visible" , position:"absolute",top:"47.7%",left:"65%"  }}
      >
        <svg
          width="22"
          height="22"
