...
const Page5_Q1_CleanAudio = () => {
  ...
  const correctAnswers = {
    a: "Nous avons dix ans.",
    b: "Il est français.",
    c: "Elles sont italiennes.",
    d: "Vous avez dix-huit ans.",
    e: "Ils sont suisses.",
    f: "Elle est anglaise"
  };
  ...
  const questions = {
    a: "Lucie et moi avons dix ans",
    b: "Sébastien est français.",
    c: "Isabelle et Margot sont italiennes.",
    d: "Jullian et toi avez dix-huit ans.",
    e: "Hugo et Théo sont suisses.",
    f: "Léa est anglaise"
  };
