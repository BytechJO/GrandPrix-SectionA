...
const Page5_Q1_CleanAudio = () => {
  ...
  const correctAnswers = {
    ...
    c: "Quelles sont vos matières préférées ?",
    d: "Quelles sont les matières que vous détestez ?",
    e: "Quel jour nous sommes aujourd’hui ?",
    f: "Quelle heure est-il ?",
    g: "Est-ce que vous participez à un club ?",
    h: "Pourquoi participez-vous à ce club ?",
  };

  // === النصوص الأصلية للأسئلة ===
  const questions = {
    a: "If you want to find out their age:",
    b: "If you want to find out their nationality:",
    c: "If you want to find out their favourite subjects:",
    d: "If you want to find out their favourite subjects:",
    e: "If you want to ask what day of the week it is:",
    f: "If you want to ask what time it is:",
    g: "If you want to ask if they go to any school clubs:",
    h: "If you want to ask why they chose this club:",
...
className="header-title-page1 w-full text-left mb-4"
  style={{ marginLeft: "42%", color:"black",marginTop:"5%",fontSize:"25px", fontWeight:"bold" }}
      >
        <span style={{backgroundColor:"#de4484"}} className="ex-A">2</span> <span style={{color:"black"}} className="number-of-q">8</span>
