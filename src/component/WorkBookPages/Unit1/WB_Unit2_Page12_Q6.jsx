...
const MatchingWithCanvas = () => {
  const leftItems = [
    ...
    "B-Mark a un livre.",
    "C-Ça va bien.",
    "D-Elles n’aiment pas la peinture.",
    "e-Non, mais Luc a une gomme.",
    "f-ls s’appellent Renard et Eugene.",
    "g-J’aime le français."
  ];
  ...
  const rightItems = [
    ...
    "3-Est-ce que tu as une gomme ?",
    "4-Quelle est sa nationalité ?",
    "5-Est-ce que Marc a un livre ?",
    "6-Quel âge as-tu ?",
    "7-Quelle matière détestent-elles ?",
    "8-Comment s’appellent-ils ?",
  ];
...
className="header-title-page1 w-full text-left mb-4"
  style={{ marginLeft: "42%", color:"black",marginTop:"5%",fontSize:"25px", fontWeight:"bold" }}
      >
        <span style={{backgroundColor:"#de4484"}} className="ex-A">2</span> <span style={{color:"black"}} className="number-of-q">6</span>
