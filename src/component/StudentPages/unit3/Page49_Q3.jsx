...
<div className="q111-questions-container" style={{width:"100%", marginLeft:"50%"}}>
 

  <div className="q11-question-lines-wrapper">
    <div className="q11-question-line">
        <span><strong>a-</strong></span>
      <span className="q11-text">Mme Dupont est</span>
      <input
    ...
    <div className="q11-question-line">
      ...
      <span className="q11-text">C’est</span>
      <input
        ...
        disabled={showResults}
      />
      <span className="q11-text">des enfants.</span>
    </div>
<span className="q11-text">Il y a sept personnes dans</span>
    <div className="q11-question-line">
      ...
      <input
        ...
        disabled={showResults}
      />
      <span className="q11-text">Dupont.</span>
    </div>

    <div className="q11-question-line">
                <span><strong>d-</strong></span>

      <span className="q11-text">Ce sont</span>
      <input
        ...
        disabled={showResults}
      />
      <span className="q11-text">de Belle,Bette et Ray.</span>
    </div>

    <div className="q11-question-line">
                <span><strong>e-</strong></span>

      <span className="q11-text">Je suis</span>
      <input
        ...
        disabled={showResults}
      />
      <span className="q11-text">de Belle</span>
    </div>
    <div className="q11-question-line">
      ...
      <input
        ...
        disabled={showResults}
      />
      <span className="q11-text">de Belle et Bette.</span>
    </div>
    <div className="q11-question-line">
                <span><strong>g-</strong></span>

      <span className="q11-text">Il y a trois</span>
      <input
        ref={inputRefs.blank7}
        type="text"
        ...
        disabled={showResults}
      />
      <span className="q11-text">dans la famille Dupont.</span>
    </div>
    <div className="q11-question-line">
                <span><strong>h-</strong></span>

      <span className="q11-text">Nous avons dix-huit ans. Nous sommes</span>
      <input
        ref={inputRefs.blank8}
        type="text"
