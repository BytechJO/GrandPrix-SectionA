...
const Page5_Q1_CleanAudio = () => {
  ...
  const getInputPositions = () => {
    ...
    return [
      { id: 0, top: "30%", left: "21%", size: inputSize },
      { id: 1, top: "45%", left: "26%", size: inputSize },
      { id: 2, top: "69%", left: "37%", size: inputSize },
      { id: 3, top: "30%", left: "47%", size: inputSize },
      { id: 4, top: "42%", left: "43%", size: inputSize },
      { id: 5, top: "76%", left: "47%", size: inputSize },
      { id: 6, top: "75%", left: "68%", size: inputSize },
      { id: 7, top: "50%", left: "66%", size: inputSize },
      { id: 8, top: "54%", left: "56%", size: inputSize },
      { id: 9, top: "30%", left: "72%", size: inputSize },
    ];
  };
